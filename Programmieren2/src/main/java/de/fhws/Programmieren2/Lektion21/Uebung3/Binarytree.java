...
public class Binarytree<E>
{
	...
	public void printBinarytree()
	{
		...
		for(Integer i : levelDepth.keySet())
		{
			...
			for(int j = 0; j < collSize; j++)
			{
				...
				{
					treeConnectorUpperPart = buildUpperTreeConnector(j, collSize, treeConnectorUpperPart, "______|________",
																						tabs);
					treeConnectorUnderPart = buildUnderTreeConnector(j, collSize, treeConnectorUnderPart, "|              |",
																						tabs);
				...
				{
					treeConnectorUpperPart = buildUpperTreeConnector(j, collSize, treeConnectorUpperPart, "______|", tabs);
					treeConnectorUnderPart = buildUnderTreeConnector(j, collSize, treeConnectorUnderPart, "______|", tabs);
					tabs = getTabs(tabs.length() - 1);
					
				}
				else if(collection.get(j).hasRight())
				{
					treeConnectorUpperPart = buildUpperTreeConnector(j, collSize, treeConnectorUpperPart, "|__________", tabs);
					treeConnectorUnderPart = buildUnderTreeConnector(j, collSize, treeConnectorUnderPart, "\t   |", tabs);
					tabs = getTabs(tabs.length() + 1);
				}
			}
			sb.append("\n");
	...
	String buildUpperTreeConnector(int j, int collSize, String existingDesign, String upperDesign, String tabs)
	{
		String upperPart = "";
	...
	String buildUnderTreeConnector(int j, int collSize, String existingDesign, String underDesign, String tabs)
	{
		String underPart = "";
